...
/* === FIX DEFINITIVO: LOGIN CELULAR COMPACTO Y ENCUADRADO === */
@media(max-width:700px){
  html,body{width:100%!important;max-width:100%!important;overflow-x:hidden!important;}
  .login-body{
    min-height:100dvh!important;
    padding:64px 10px 76px!important;
    align-items:flex-start!important;
    justify-content:center!important;
    overflow-y:auto!important;
  }
  .login-body:before{height:25%!important;clip-path:polygon(0 42%,28% 30%,56% 22%,82% 32%,100% 28%,100% 100%,0 100%)!important;}
  .login-body:after{font-size:11px!important;line-height:1.55!important;bottom:8px!important;padding:0 10px!important;}
  .login-card{
  ...
  .login-avatar-svg{width:96px!important;height:96px!important;}
  .login-avatar-svg:before{width:54px!important;height:54px!important;}
  .login-title{margin:0 0 16px!important;}
  .login-title h1{font-size:26px!important;line-height:1.05!important;letter-spacing:-.03em!important;white-space:nowrap!important;}
  .login-title b{font-size:13.5px!important;line-height:1.22!important;max-width:260px!important;}
  .login-title:after{width:50px!important;height:3px!important;margin:12px auto 0!important;}
  .login-card .field{margin-bottom:10px!important;}
  .login-card .field label{font-size:13px!important;margin:0 0 5px!important;font-weight:720!important;}
  .login-input{height:48px!important;border-radius:15px!important;padding:0 8px!important;gap:8px!important;}
  .login-input i{width:28px!important;height:28px!important;border-radius:9px!important;font-size:14px!important;}
  .login-input input,.login-input select{height:38px!important;min-height:38px!important;font-size:14.5px!important;border-radius:13px!important;padding:0 10px!important;}
  .login-card .btn-green{height:50px!important;border-radius:15px!important;font-size:17px!important;margin:13px 0 14px!important;}
  .login-links a{font-size:13px!important;}
}
@media(max-width:380px){
  .login-body{padding-top:58px!important;padding-bottom:70px!important;}
  .login-card{max-width:330px!important;padding-left:16px!important;padding-right:16px!important;margin-top:24px!important;}
  .login-title h1{font-size:24px!important;}
  .login-title b{font-size:13px!important;}
  .login-input{height:46px!important;}
  .login-input input,.login-input select{height:36px!important;font-size:14px!important;}
  .login-card .btn-green{height:48px!important;font-size:16px!important;}
}
</style>\n'
        html_text = html_text.replace('</head>', css + '</head>')
        response.set_data(html_text)
