# -*- coding: utf-8 -*-
"""
Portal de PORTAL HR PRO - Versión Ultra Mejorada
...
def bloquear_modulo_contratacion_portal_hr():
    ...
    if ruta.startswith('/admin/contratacion') or ruta.startswith('/contratacion/') or ruta.startswith('/admin/firma') or ruta.startswith('/firma/'):
...
def render_page(content, title="Portal de PORTAL HR PRO", active="Inicio"):
...
def login_template(admin=False, error=""):
    ...
    title = "Administrador PORTAL HR PRO" if admin else "Portal PORTAL HR PRO"
